...
class ShoppingBasket:
    # {{"name":'uddin'} }
    user_lst = [] # [{"name": "uddim", "password": "123"}, {"name": "naim", "password": "124"}] --> dictionary
                  # [["uddin", "1234"], ["naim", "1234"]] --> list
    user_ordered_data = {} # {"uddin" : [{"itemID" : 12, "price" : 200, "description" : 'abdc', "quantity" : 12}, {"itemID" : 13, "price" : 200, "description" : 'abdc', "quantity" : 12}]}
    ...
    def create_account(self):
        ...
        # True mane hocche user already ache, False mane hocche notun user
        isNameExist = False 
        for user in self.get_userslst(): # user already ache kina seta check
            ...
            # notun ekjon user uni, unake misty khawao
...
# a = {"uddin" : [{"itemID" : 12, "price" : 200, "description" : 'abdc', "quantity" : 12}]}
# # for i in a['uddin']:
# #     if i['itemID'] == 12:
# #         i['quantity'] = 134 
# # print(a['uddin'])
...
# b = {"uddi" : [{"itemID" : 12, "price" : 200, "description" : 'abdc', "quantity" : 12}, {"itemID" : 13, "price" : 200, "description" : 'abdc', "quantity" : 12}], "naim" : [{"itemID" : 12, "price" : 200, "description" : 'abdc', "quantity" : 12}, {"itemID" : 13, "price" : 200, "description" : 'abdc', "quantity" : 12}]}
